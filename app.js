...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    pages = ['page-home', 'page-history', 'page-account', 'page-help', 'page-request-leave', 'page-request-out', 'page-daily-attendance', 'page-approver']; // Added 'page-approver'
    ...
    // === START: MODIFIED navigateTo Function ===
    function navigateTo(pageId) { 
        console.log("Navigating to page:", pageId); 
        const isSpecialPage = ['page-request-leave', 'page-request-out', 'page-daily-attendance', 'page-approver'].includes(pageId);
        ...
        // ត្រូវតែ scroll តែពេលមិនមែនជា Attendance Page (ដែលត្រូវប្រើកម្ពស់ពេញ)
        if (mainContent && pageId !== 'page-daily-attendance') {
